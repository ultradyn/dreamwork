...
| `.dreamwork/docs/plans/` | Active feature plans (ud-dreamtask, ud-dreamwork-github, artifact-templates, daemon-mode, dreamhub-stage1, parallel-architecture, multi-dreamer, goal-hierarchies, composer-row) | Prune when features fully land |
