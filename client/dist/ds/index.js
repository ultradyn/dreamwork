...
var DreamworkDesign = (() => {
  ...
  function armPostureUI(draft, until, gen) {
    ...
    const setCount = () => {
      ...
      const label2 = draft.pace + " · " + draft.asking + " · " + draft.delegation;
