...
| R11 | **Run-mode arm bar / posture / rolls** (#290/#445/#454) | Functionally survives | swap | **Yes.** `syncRunModeFromData` (`watch.py:5605 @ e55791eb`), `syncPostureFromData` (`watch.py:6249 @ e55791eb`), `restoreRolls` (`watch.py:7338`). |
