...
sanctioned door (dreamwork_db/core.py); route them through dreamwork_db.core instead:
    temporary red-proof injection replacing 6641ad76:watch.py:3476 (restored before commit): _sabotage = sqlite3.connect(str(db))  # REDPROOF: raw connect reintroduced
```
