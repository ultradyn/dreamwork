...
literal (`watch.py:3712` `const BURN_LIMIT_CAP = 256;`, rendered into
`max=` at watch.py:3931) is bound by nothing.
...
- **Red-first, and your red IS the finding's repro**: sabotage
  `watch.py:3712` (256→168 — a pre-existing line you did NOT inject),
