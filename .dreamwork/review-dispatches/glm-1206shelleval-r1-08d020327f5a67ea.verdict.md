...
The head-path contract remains unchanged: `dev/launch_lane.py` is outside the diff and still calls `head_path.read_text()` at [dev/launch_lane.py line 464](/home/xertrov/.llm-general/skills/.worktrees/glm-1206shelleval-review-r1/dev/launch_lane.py line 464). In an isolated Git fixture, passing 400 bytes of content as the positional produced `[Errno 36] File name too long`.
