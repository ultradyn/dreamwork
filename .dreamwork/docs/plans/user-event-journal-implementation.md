...
**Status:** **lanes A–D and F authorised** 2026-07-28 05:43 (`8c5c9cf`), and **all five are now LANDED** — A `aad1d8d` (2/2) · B `6a865e4`..`bc731cf` (8/8, two batches) · C `3f1a6af`, `8c1bb60` (3/3) · **D `6cd9f95` (4/4, 07:25)** · F `2386345` (4/4). Lanes **E** (the HTTP cutover, increments 20–25) and **H** (the version gate, 34–35) remain **unauthorised behind the second gate**, whose stated condition — *"once A–D are proved"* — **is met**; opening it is his, and the ask is open in `questions.md` from 2026-07-28 16:30. Lane **G** (30–33) was never in G1 and stays withheld regardless. §"What this plan does not authorise" still binds everything it names.
